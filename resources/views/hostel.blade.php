        ...
        <section class="hostel grey lighten-3">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m6 middle card-panel z-depth-0 ">
                        <h4 class="grey-text center">{{ $host->name }}</h4>
                                ...
                                <div class="card accent" href="{{ route('home') }}">
                                    ...
                                    <div class="card-content secondary white-text">
                                        <h4 class=""> <i class="material-icons  accent-text">location_on</i> {{
                                            $host->location }} </h4>
...
@endfor
             ...
             @if($r->booked_bed<$r->total_bed)
                                             ...
                                             <div class="col m2 l1 s3 " style=" margin:10px 10px; ">
                                                     <a href="{{ route('room.book',['host'=>str_slug($r->hostel_name),'room_no'=>$r->room_no]) }}" class="btn btn-floating white secondary-text flow-text pulse waves-effect waves-light" style=" margin:0px 10px; display:block; text-align:center;">{{
                                                         $r->room_no}}</a>
                                         ...
                                         @else
                                         <div class="col m2 l1 s3 " style=" margin:10px 10px; ">
                                                 <a href="{{ route('room.book',['host'=>str_slug($r->hostel_name),'room_no'=>$r->room_no]) }}" class="btn btn-floating secondary white-text flow-text waves-effect waves-light" style=" margin:0px 10px; display:block; text-align:center;">{{
                                                     $r->room_no}}</a>
                ...
                <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col s12 m4">
                      <div class="card">
                        <div class="card-image">
                          <img src="{{ asset('assets/img/bed-bedroom-cozy-164595.jpg') }}" alt="" class="responsive-img">
                    ...
                    <div class="col s12 m4">
                      <div class="card">
                        <div class="card-image">
                          <img src="{{ asset('assets/img/bed-bedroom-comfort-1148927.jpg') }}" alt="" class="responsive-img">
                          <span class="card-title">Lorem, ipsum dolor.</span>
                        </div>
                        <div class="card-body">
                          <div class="card-content">
                    ...
                    <div class="col s12 m4">
                      <div class="card">
                        <div class="card-image">
                          <img src="{{ asset('assets/img/bedroom-door-entrance-271639.jpg') }}" alt="" class="responsive-img">
                          <span class="card-title">Lorem, ipsum dolor.</span>
                        </div>
                        <div class="card-body">
                          <div class="card-content">
                    ...
                    <div class="col s12 m4">
                      <div class="card">
                        <div class="card-image">
                          <img src="{{ asset('assets/img/apartment-chair-comfort-271614.jpg') }}" alt="" class="responsive-img">
                          <span class="card-title">Lorem, ipsum dolor.</span>
                        </div>
                        <div class="card-body">
                          <div class="card-content">
                    ...
                    <div class="col s12 m4">
                      <div class="card">
                        <div class="card-image">
                          <img src="{{ asset('assets/img/apartment-bed-bedroom-271624.jpg') }}" alt="" class="responsive-img">
                          <span class="card-title">Lorem, ipsum dolor.</span>
                        </div>
                        <div class="card-body">
                          <div class="card-content">
