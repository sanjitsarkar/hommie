...
<body>
  ...
  <header class="header">
    ...
    <div class="signup col s12" id="signup">
      ...
      <ul class="slides">
        <li>
          <img src="<?php echo e(asset('assets/img/apartment-bed-bedroom-271624.jpg')); ?>" alt="">
        ...
        <li>
          <img src="<?php echo e(asset('assets/img/apartment-bed-bedroom-271672.jpg')); ?>" alt="">
        ...
        <li>
          <img src="<?php echo e(asset('assets/img/apartment-chair-comfort-271614.jpg')); ?>" alt="">
        ...
        <li>
          <img src="<?php echo e(asset('assets/img/bed-bedroom-comfort-1148927.jpg')); ?>" alt="">
          <div class="caption right-align">
        ...
        <li>
          <img src="<?php echo e(asset('assets/img/bed-bedroom-hostel-4217.jpg')); ?>" alt="">
          <div class="caption center-align">
            <h3>Lorem ipsum dolor sit amet.</h2>
              <h5 class="white-text hide-on-small-only light text-lighten-3">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
