...
<section class="results">
    ...
    <?php if($search==""): ?>
        ...
        <h6 class="white-text center"><?php echo e($res); ?></h6>


    <?php else: ?>
        <h5 class="white-text center">Search Results For: <?php echo e($search); ?></h5>
        <?php if($hosts->count()>1): ?>

        <h6 class="white-text center"><?php echo e($hosts->count()); ?> Hostels Found</h6>
<?php if($hosts->count()==1): ?>
<h6 class="white-text center"><?php echo e($hosts->count()); ?> Hostel Found</h6>
<?php endif; ?>
        <?php endif; ?>
    <div class="container">
...
<h5 class="small accent-text"><i class="material-icons accent-text">school</i> <?php echo e($host->college); ?> </h5>
...
<div class="card-action">
    ...
    <a href="<?php echo e(route('hostel.book',['name'=>$host->slug])); ?>" class="btn right primary">Book Room</a>
